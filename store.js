...
function ready () {
    // Removing items from the cart using the remove buttons
...
function updateCartIconNumber () {
    ...
    for (var i = 0; i < cartRows.length; i++) {
        var cartRow = cartRows[i];
        var quantityElement = cartRow.getElementsByClassName("cart-quantity-input")[0];
        myCart = parseInt(myCart) + parseInt(quantityElement.value);
    }

    document.getElementById("cartspan").innerText = myCart;
...
var testForm = document.getElementById('test-form');
    ...
    testForm.addEventListener("submit", function (event) {
        ...
        event.preventDefault(); // Prevents autosubmission of form
